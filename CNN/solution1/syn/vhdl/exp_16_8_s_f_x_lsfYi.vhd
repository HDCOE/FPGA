...
entity exp_16_8_s_f_x_lsfYi_rom is 
    generic(
             DWIDTH     : integer := 11; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_16_8_s_f_x_lsfYi_rom is 
...
entity exp_16_8_s_f_x_lsfYi is
    generic (
...
architecture arch of exp_16_8_s_f_x_lsfYi is
    component exp_16_8_s_f_x_lsfYi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_16_8_s_f_x_lsfYi_rom_U :  component exp_16_8_s_f_x_lsfYi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
