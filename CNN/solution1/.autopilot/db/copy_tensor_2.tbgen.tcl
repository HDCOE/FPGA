...
set C_modelName {copy_tensor.2}
set C_modelType { void 0 }
set C_modelArgList {
	{ in1_V int 16 regular {array 27 { 0 } 0 1 }  }
...
set portList { 
	...
	{ in1_V_address0 sc_out sc_lv 5 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in1_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "in1_V", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	in1_V { ap_memory {  { in1_V_address0 mem_address 1 5 }  { in1_V_ce0 mem_ce 1 1 }  { in1_V_we0 mem_we 1 1 }  { in1_V_d0 mem_din 1 16 } } }
