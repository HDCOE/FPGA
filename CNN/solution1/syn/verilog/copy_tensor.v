...
input  [15:0] in2_0_V_read;
input  [15:0] in2_1_V_read;
input  [31:0] size1_x;
input  [31:0] size1_y;
...
reg   [1:0] k_1_reg_210;
wire   [15:0] in2_1_V_read_assign_fu_148_p3;
reg   [15:0] in2_1_V_read_assign_reg_215;
...
assign in1_V_d0 = in2_1_V_read_assign_reg_215;

assign in2_1_V_read_assign_fu_148_p3 = ((tmp_24_fu_144_p1[0:0] === 1'b1) ? in2_1_V_read : in2_0_V_read);
...
assign tmp_24_fu_144_p1 = k_reg_79[0:0];

assign tmp_8_fu_177_p1 = $signed(tmp_s_fu_172_p2);

assign tmp_fu_158_p2 = (j_cast3_fu_154_p1 + phi_mul_reg_90);

assign tmp_s_fu_172_p2 = (i_cast2_fu_168_p1 + tmp3_reg_225);

endmodule //copy_tensor
