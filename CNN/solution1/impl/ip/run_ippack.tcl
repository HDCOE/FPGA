...
set Interfaces {
    s_axi_axilite {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x20 data_in_size_x W 0x0 "Data signal of data_in_size_x" {{0 32 data_in_size_x W 0 "Bit 31 to 0 Data signal of data_in_size_x"}}} {0x28 data_in_size_y W 0x0 "Data signal of data_in_size_y" {{0 32 data_in_size_y W 0 "Bit 31 to 0 Data signal of data_in_size_y"}}} {0x30 data_in_size_z W 0x0 "Data signal of data_in_size_z" {{0 32 data_in_size_z W 0 "Bit 31 to 0 Data signal of data_in_size_z"}}} {0x50 conv_size_x W 0x0 "Data signal of conv_size_x" {{0 32 conv_size_x W 0 "Bit 31 to 0 Data signal of conv_size_x"}}} {0x58 conv_size_y W 0x0 "Data signal of conv_size_y" {{0 32 conv_size_y W 0 "Bit 31 to 0 Data signal of conv_size_y"}}} {0x60 conv_size_z W 0x0 "Data signal of conv_size_z" {{0 32 conv_size_z W 0 "Bit 31 to 0 Data signal of conv_size_z"}}} {0x80 relu_size_x W 0x0 "Data signal of relu_size_x" {{0 32 relu_size_x W 0 "Bit 31 to 0 Data signal of relu_size_x"}}} {0x88 relu_size_y W 0x0 "Data signal of relu_size_y" {{0 32 relu_size_y W 0 "Bit 31 to 0 Data signal of relu_size_y"}}} {0x90 relu_size_z W 0x0 "Data signal of relu_size_z" {{0 32 relu_size_z W 0 "Bit 31 to 0 Data signal of relu_size_z"}}} {0xb0 pool_size_x W 0x0 "Data signal of pool_size_x" {{0 32 pool_size_x W 0 "Bit 31 to 0 Data signal of pool_size_x"}}} {0xb8 pool_size_y W 0x0 "Data signal of pool_size_y" {{0 32 pool_size_y W 0 "Bit 31 to 0 Data signal of pool_size_y"}}} {0xc0 pool_size_z W 0x0 "Data signal of pool_size_z" {{0 32 pool_size_z W 0 "Bit 31 to 0 Data signal of pool_size_z"}}} {0xe0 fc_size_x W 0x0 "Data signal of fc_size_x" {{0 32 fc_size_x W 0 "Bit 31 to 0 Data signal of fc_size_x"}}} {0xe8 fc_size_y W 0x0 "Data signal of fc_size_y" {{0 32 fc_size_y W 0 "Bit 31 to 0 Data signal of fc_size_y"}}} {0xf0 fc_size_z W 0x0 "Data signal of fc_size_z" {{0 32 fc_size_z W 0 "Bit 31 to 0 Data signal of fc_size_z"}}} {0x140 data_out_size_x W 0x0 "Data signal of data_out_size_x" {{0 32 data_out_size_x W 0 "Bit 31 to 0 Data signal of data_out_size_x"}}} {0x148 data_out_size_y W 0x0 "Data signal of data_out_size_y" {{0 32 data_out_size_y W 0 "Bit 31 to 0 Data signal of data_out_size_y"}}} {0x150 data_out_size_z W 0x0 "Data signal of data_out_size_z" {{0 32 data_out_size_z W 0 "Bit 31 to 0 Data signal of data_out_size_z"}}}}
