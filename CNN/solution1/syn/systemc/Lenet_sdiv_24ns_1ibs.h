...
#ifndef __Lenet_sdiv_24ns_1ibs__HH__
#define __Lenet_sdiv_24ns_1ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Lenet_sdiv_24ns_1ibs) {
    ...
    SC_CTOR(Lenet_sdiv_24ns_1ibs):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
