...
architecture behav of copy_tensor is 
    ...
    signal in2_1_V_read_assign_fu_148_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal in2_1_V_read_assign_reg_215 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal tmp_24_fu_144_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_s_fu_172_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond2_fu_132_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                in2_1_V_read_assign_reg_215 <= in2_1_V_read_assign_fu_148_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    in1_V_address0 <= tmp_8_fu_177_p1(3 - 1 downto 0);
    ...
    in1_V_d0 <= in2_1_V_read_assign_reg_215;
    ...
    in2_1_V_read_assign_fu_148_p3 <= 
        in2_1_V_read when (tmp_24_fu_144_p1(0) = '1') else 
        in2_0_V_read;
    ...
    tmp_24_fu_144_p1 <= k_reg_79(1 - 1 downto 0);
        tmp_8_fu_177_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_s_fu_172_p2),64));

    tmp_fu_158_p2 <= std_logic_vector(unsigned(j_cast3_fu_154_p1) + unsigned(phi_mul_reg_90));
    tmp_s_fu_172_p2 <= std_logic_vector(unsigned(i_cast2_fu_168_p1) + unsigned(tmp3_reg_225));
end behav;
