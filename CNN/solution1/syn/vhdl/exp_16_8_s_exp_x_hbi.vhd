...
entity exp_16_8_s_exp_x_hbi_rom is 
    generic(
             DWIDTH     : integer := 25; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_16_8_s_exp_x_hbi_rom is 
...
entity exp_16_8_s_exp_x_hbi is
    generic (
...
architecture arch of exp_16_8_s_exp_x_hbi is
    component exp_16_8_s_exp_x_hbi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_16_8_s_exp_x_hbi_rom_U :  component exp_16_8_s_exp_x_hbi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
